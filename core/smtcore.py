...
def metasploit():
	...
	os.system("mv metasploit.sh ~;cd ~;bash metasploit.sh")
	print '###### Done'
...
def rat():
        ...
        os.system('apt update && apt upgrade')
        os.system('apt install git php')
        os.system('git clone https://github.com/Rizee0/Rat-Hunter')
        os.system('mv Rat-Hunter ~')
        print '###### Done'
        backtomenu_option()
